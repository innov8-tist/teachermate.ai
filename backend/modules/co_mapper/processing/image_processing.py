"""
Image Processing
Handles student answer sheet image processing: splitting, cropping, and OCR enhancement
Migrated from comapping/answer_sheet_processing/cutting.py
"""
...
class ImageProcess:
    """Process student answer sheet images for OCR extraction"""
    ...
    def _middle_crop(self, image_name: str, top_ratio: float, bottom_ratio: float, output: str):
        """Internal method to crop middle section of image"""
        img = Image.open(image_name)
        width, height = img.size
